          ...
          <form id="agregarRouter" enctype="multipart/form-data">
            ...
            <div class="modal-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <div class="input-group mb-3">
                    <textarea class="form-control" rows="2" placeholder="Ej. SM, TLALT, ALM"></textarea>
                  </div>
                </div>
              </div>
            </div>
            <div class="modal-footer justify-content-between">
              ...
              <div>
                <button type="button" class="btn btn-outline-info" onclick="conexion()">Comprobar Conexión</button>
